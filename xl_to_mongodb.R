...
dbname<-readline(prompt="Enter the Database Name: ")
username<-readline(prompt="Enter the Username: ")
password<-readline(prompt="Enter the Password: ")
collection<-readline(prompt="Enter the name of the Collection (Table): ")
authenticated <- dbAuthenticate(dbname, username, password)
dbInsertDocument(dbname, collection, json_data)
dbDisconnect(dbname)